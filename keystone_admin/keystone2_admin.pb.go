...
var file_keystone2_admin_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x65, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x42, 0x12, 0x5a, 0x10,
	0x2e, 0x2f, 0x6b, 0x65, 0x79, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e,
...
var file_keystone2_admin_proto_goTypes = []interface{}{
	...
	(*keystone.KeyRef)(nil),  // 4: keystone.keyRef
	(*keystone.Empty)(nil),   // 5: keystone.empty
	(*keystone.KeySpec)(nil), // 6: keystone.keySpec
	(*keystone.Result)(nil),  // 7: keystone.result
}

...
func (c *keyringAdminClient) Label(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*KeyringLabel, error) {
...
func (c *keyringAdminClient) Remove(ctx context.Context, in *KeySpec, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (UnimplementedKeyringAdminServer) Label(context.Context, *Empty) (*KeyringLabel, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Label not implemented")
}
func (UnimplementedKeyringAdminServer) Remove(context.Context, *KeySpec) (*Result, error) {
...
func _KeyringAdmin_Label_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyringAdminServer).Label(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KeyringAdmin_Remove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyringAdminServer).Remove(ctx, req.(*KeySpec))
	}
	return interceptor(ctx, in, info, handler)
}
